...
namespace Tutorial.Inventory
{
    class Inventory : Script
    {
            ...
            using (MySqlDataReader reader = command.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    if (item.ownerEntity == "Ground")
                    {
                        ...
                        item.textHandle = NAPI.TextLabel.CreateTextLabel("Có cái gì đó ở đây - sử dụng /pickup!", new Vector3(posX, posY, posZ + 0.5), 10.0f, 0.5f, 4, new Color(255, 255, 255));
                    }
                    itemList.Add(item);
                }
            }
                ...
                case "konsumieren":
                    {
                        ...
                        item.amount--;
                        string message = $"Bạn tiêu thụ một {getItem.descriptionitem}";
                ...
                case "wegwerfen":
                    {
                        ...
                        else
                        {
                            ...
                            closestItem.textHandle = NAPI.TextLabel.CreateTextLabel("Có cái gì đó ở đây - sử dụng /pickup!", new Vector3(player.Position.X, player.Position.Y, player.Position.Z - 0.5), 10.0f, 0.5f, 4, new Color(255, 255, 255));
        ...
        [Command("inventory", "Lệnh: /inventory để mở kho đồ của bạn")]
        ...
        [Command("pickup", "Lệnh: /pickup để nhặt đồ")]
        public void CMD_pickup(Player player)
        {
            ...
            if(item != null)
            {
                ...
                RemoveItem(item.id);
                player.SendChatMessage($"Bạn đã nhặt thành công thứ gì đó!");
            }
        }
